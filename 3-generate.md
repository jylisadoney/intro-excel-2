...
1. Values
  1. Fields you want to `measure`
1. Columns
  1. Headings that represent your selected `values` 
1. Rows
  1. Fields you want to use to `group and categorize` your data
1. Filters
  1. Fields you want to use to `isolate or focus` your data
