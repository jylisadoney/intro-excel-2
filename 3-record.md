...
{% include figure.html file="PersonalMacroWorkbook_SavePrompt.jpg" alt="Excel workbook with terminology labels" caption="Microsoft Excel Personal Macro Workbook Save Prompt" %}
